...
Reusable web UI components for building AI chat interfaces powered by [@sheason/pi-ai](../ai) and [@sheason/pi-agent-core](../agent).
...
```bash
npm install @sheason/pi-web-ui @sheason/pi-agent-core @sheason/pi-ai
```
...
import '@sheason/pi-web-ui/app.css';
...
declare module '@sheason/pi-agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@sheason/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@sheason/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@sheason/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@sheason/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@sheason/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@sheason/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@sheason/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@sheason/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@sheason/pi-web-ui';
...
```typescript
import { ModelSelector } from '@sheason/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@sheason/pi-web-ui';
