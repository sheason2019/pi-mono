...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@sheason/pi-coding-agent";
...
```bash
npm install @sheason/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@sheason/pi-coding-agent";
...
The `Agent` class (from `@sheason/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@sheason/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@sheason/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@sheason/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@sheason/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@sheason/pi-coding-agent";
