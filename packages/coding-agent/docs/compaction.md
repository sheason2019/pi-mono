...
For TypeScript definitions in your project, inspect `node_modules/@sheason/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@sheason/pi-coding-agent";
