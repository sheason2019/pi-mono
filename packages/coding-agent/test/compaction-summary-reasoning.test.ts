...
import type { AssistantMessage, Model } from "@sheason/pi-ai";
...
vi.mock("@sheason/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@sheason/pi-ai")>();
	return {
		...actual,
