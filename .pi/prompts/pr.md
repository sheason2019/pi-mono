...
6. Check if `README.md` or `packages/d-pi` docs/tests require modification. This is usually the case when existing features have been changed, or new features have been added.
